...
description: Review and prioritize managed Areas and projects within one domain. Use for portfolio status, focus selection, pause or retirement recommendations, or an explicitly requested compact cross-domain capacity review. Do not use for detailed weekly scheduling, one-record stewardship, or silent portfolio classification.
---
...
For a read-only review, do not change classifications, lifecycle, priorities, tasks, or xPM state. When the user separately authorizes maintenance, reconcile only the accepted changes and preserve unrelated human state.

## Deliver

Lead with the focus recommendation, followed by concise evidence, displacement, unresolved classification gaps, and one concrete next action.
